...
> ⚠️ New Relic offers a new [Ansible solution](https://github.com/newrelic/ansible-install) that simplifies scaling your New Relic Observability efforts.
> Please consider using this solution going forward. 
> It utilizes the New Relic CLI and the New Relic Open Installation repository, resulting in broader coverage and improved usability for various scenarios.
